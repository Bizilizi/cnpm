...
from .surface_point_cloud import BadMeshException, create_from_scans
from .utils import (
    check_voxels,
    get_raster_points,
    scale_to_unit_cube,
...
def sample_sdf_near_surface(
    ...
    if isinstance(mesh, trimesh.Trimesh):
        raise ValueError("Expected trimesh.Scene")
    ...
    points, sdf_values, colors = surface_point_cloud.sample_sdf_near_surface(
        number_of_points,
        surface_point_method == "scan",
        sign_method,
        normal_sample_count,
    ...
    return points, sdf_values, colors
